...
full_name = StrField("Full Name", dependencies=[first_name, last_name], computed=compute_full_name)
date_of_birth = DateField("Date of Birth")
over_18 = BoolField("Over 18", dependencies=[date_of_birth], computed=compute_over_18)
form = Form()
