...
from . import Field, StrField, DateField, IntField, BoolField
...
def full_name(first_name, last_name):
    return StrField(
        ...
        compute=lambda first, last: first + " " + last)
...
@pytest.fixture
def over_18():
    return BoolField("Over 18", compute=compute_over_18)
